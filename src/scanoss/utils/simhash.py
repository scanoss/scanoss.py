"""
A Python re‐implementation of the Go simhash package.
It produces the same EXACT results as the Go implementation given the same input.

See the original Go code:
  - https://github.com/mfonda/simhash
  - Copyright 2013 Matthew Fonda. MIT License.
"""
