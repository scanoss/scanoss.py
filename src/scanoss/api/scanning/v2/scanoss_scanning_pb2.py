...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_HFHREQUEST'].fields_by_name['best_match']._loaded_options = None
  _globals['_HFHREQUEST'].fields_by_name['best_match']._serialized_options = b'\030\001'
  _globals['_HFHREQUEST'].fields_by_name['threshold']._loaded_options = None
  _globals['_HFHREQUEST'].fields_by_name['threshold']._serialized_options = b'\030\001'
  _globals['_HFHRESPONSE_RESULT'].fields_by_name['probability']._loaded_options = None
  _globals['_HFHRESPONSE_RESULT'].fields_by_name['probability']._serialized_options = b'\030\001'
  _globals['_HFHRESPONSE_RESULT'].fields_by_name['stage']._loaded_options = None
  _globals['_HFHRESPONSE_RESULT'].fields_by_name['stage']._serialized_options = b'\030\001'
  ...
  _globals['_HFHREQUEST']._serialized_end=696
  _globals['_HFHREQUEST_CHILDREN']._serialized_start=381
  _globals['_HFHREQUEST_CHILDREN']._serialized_end=696
  _globals['_HFHREQUEST_CHILDREN_LANGEXTENSIONSENTRY']._serialized_start=643
  _globals['_HFHREQUEST_CHILDREN_LANGEXTENSIONSENTRY']._serialized_end=696
  _globals['_HFHRESPONSE']._serialized_start=699
  _globals['_HFHRESPONSE']._serialized_end=1045
  _globals['_HFHRESPONSE_COMPONENT']._serialized_start=831
  _globals['_HFHRESPONSE_COMPONENT']._serialized_end=905
  _globals['_HFHRESPONSE_RESULT']._serialized_start=908
  _globals['_HFHRESPONSE_RESULT']._serialized_end=1045
  _globals['_SCANNING']._serialized_start=1048
  _globals['_SCANNING']._serialized_end=1305
